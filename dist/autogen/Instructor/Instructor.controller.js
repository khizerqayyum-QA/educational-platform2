...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve multiple Instructors' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], InstructorController.prototype, "getMany", null);
__decorate([
    (0, crud_1.Override)('getOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve a single Instructor' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], InstructorController.prototype, "get", null);
__decorate([
    (0, crud_1.Override)('createOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Create a single Instructor' }),
    (0, swagger_1.ApiBody)({
        type: Instructor_dto_1.InstructorCreate,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Instructor_dto_1.Instructor]),
    __metadata("design:returntype", void 0)
], InstructorController.prototype, "create", null);
__decorate([
    (0, crud_1.Override)('createManyBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Create multipleInstructors' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], InstructorController.prototype, "createMany", null);
__decorate([
    (0, crud_1.Override)('updateOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a single Instructor' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Instructor_dto_1.Instructor]),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Replace a single Instructor' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Instructor_dto_1.Instructor]),
    __metadata("design:returntype", void 0)
], InstructorController.prototype, "replace", null);
__decorate([
    (0, crud_1.Override)('deleteOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a single Instructor' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
exports.InstructorController = InstructorController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: Instructor_dto_1.Instructor,
        },
        dto: {
            create: Instructor_dto_1.InstructorCreate,
            update: Instructor_dto_1.Instructor,
            replace: Instructor_dto_1.Instructor,
        },
        query: {
            limit: 5,
            alwaysPaginate: true,
